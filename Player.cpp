...
//        }
//        if(SHindicator){
//            ST7735_DrawFastHLine(x, flip_y, 10, ST7735_BLUE);
//            ST7735_DrawFastHLine(x, flip_y+1, 10, ST7735_BLUE);
//        } else{
//            ST7735_DrawFastHLine(x, flip_y, 10, 0xCC66);
//            ST7735_DrawFastHLine(x, flip_y+1, 10, 0xCC66);
//        }
//        if(RFindicator){
//            ST7735_DrawFastHLine(x, flip_y+3, 10, ST7735_YELLOW);
//            ST7735_DrawFastHLine(x, flip_y+4, 10, ST7735_YELLOW);
//        } else{
//            ST7735_DrawFastHLine(x, flip_y+3, 10, 0xCC66);
//            ST7735_DrawFastHLine(x, flip_y+4, 10, 0xCC66);
//        }
//    } else{
//        if(DEindicator){
//            ST7735_DrawFastVLine(3, y, 10, ST7735_RED);
//        } else{
//            ST7735_DrawFastVLine(3, y, 10, 0xCC66);
//        }
//        if(SHindicator){
//            ST7735_DrawFastVLine(5, y, 10, ST7735_BLUE);
//        } else{
//            ST7735_DrawFastVLine(5, y, 10, 0xCC66);
//        }
//        if(RFindicator){
//            ST7735_DrawFastVLine(7, y, 10, ST7735_YELLOW);
//        } else{
//            ST7735_DrawFastVLine(7, y, 10, 0xCC66);
//        }
//    }
}
